            ...
            <div class="panel panel-default" id="form">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" min=0 class="form-control" id="textStock" name="textStock" placeholder="10" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" min=0 class="form-control" id="textOrderd" name="textOrderd" placeholder="10" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" min=0 class="form-control" id="textDeliverd" name="textDeliverd" placeholder="10" required="">
                        </div>
                    </div>
